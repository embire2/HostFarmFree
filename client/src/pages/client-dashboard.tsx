  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* ALWAYS VISIBLE CREDENTIALS - Top Priority */}
        <div className="mb-8">
          <Card className="border-2 border-blue-500 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 shadow-lg">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-blue-700 dark:text-blue-200 text-sm mb-4">
                    <strong>Keep these safe!</strong> You'll need them to access your hosting account and services.
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-3">
                      <label className="text-sm font-bold text-blue-800 dark:text-blue-200 uppercase tracking-wide">
                        🔑 Username
                      </label>
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          value={user?.username || ''}
                          readOnly
                          className="flex-1 px-4 py-3 bg-white dark:bg-gray-800 border-2 border-blue-300 dark:border-blue-600 rounded-lg font-mono text-lg font-bold text-blue-900 dark:text-blue-100 shadow-inner"
                        />
                        <Button
                          size="sm"
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        <input
                          type="text"
                          value={user?.displayPassword || tempCredentials?.password || "Contact support for password"}
                          readOnly
                          className="flex-1 px-4 py-3 bg-white dark:bg-gray-800 border-2 border-blue-300 dark:border-blue-600 rounded-lg font-mono text-lg font-bold text-blue-900 dark:text-blue-100 shadow-inner"
                        />
                        <Button
                          ...
                          className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2"
                          onClick={() => {
                            const password = user?.displayPassword || tempCredentials?.password;
                            if (password && password !== "Contact support for password") {
                              ...
                              toast({
                                title: "⚠️ Password Not Available",
                                description: "Password was only shown during registration",
                                variant: "destructive",
                              });
                            }
                          }}
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-300">
                        {user?.displayPassword ? 
                          "✅ Password permanently stored and always available" :
                          tempCredentials?.password ? 
                            "✅ Password currently available" :
                            "⚠️ Password was only shown during registration. Use recovery phrase if lost."
                        }
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="mt-6 space-y-3">
                      ...
                      <div className="flex items-center space-x-3">
                        <input
                          ...
                          readOnly
                          className="flex-1 px-4 py-3 bg-white dark:bg-gray-800 border-2 border-blue-300 dark:border-blue-600 rounded-lg font-mono text-sm font-bold text-blue-900 dark:text-blue-100 shadow-inner"
                        />
                        <Button
                          size="sm"
                          className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-4 py-2"
                  ...
                  <div className="mt-6 flex space-x-3">
                    <Button
                      ...
                      onClick={() => {
                        const password = user?.displayPassword || tempCredentials?.password || "Password not available";
                        const credentials = `Username: ${user?.username || ''}\nPassword: ${password}\nRecovery Phrase: ${user?.recoveryPhrase || ''}`;
